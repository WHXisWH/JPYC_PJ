...
function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: '遊休算力レンタル',
      description:
        '平日・日中の空きPCをAI/MLレンダリングノードとして提供。店舗は座席収入に加え算力収益を獲得。',
      color: 'bg-emerald-50',
      badge: '算力市場',
    ...
    },
    {
      ...
      title: '収益レポート',
      description:
        '座席売上・算力収益・返金・手数料を日次/週次/月次で一覧。JPYC出金リクエストもダッシュボードから。',
      color: 'bg-sky-50',
      badge: '事業者向け',
      badgeColor: 'badge-blue',
    },
      ...
      <div className="container-main">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-lg max-w-xl mx-auto">
            利用者・店舗・算力需要者の三者が共に恩恵を受ける、持続可能なエコシステム
          </p>
        </div>
      ...
      <div className="container-main">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg max-w-md mx-auto">
            平日・日中の空きPCを算力ノードとして提供し、座席収入に加えて新たな収益源を確保
          </p>
        </div>
