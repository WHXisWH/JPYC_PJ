...
// マイパス管理ページ
// ユーザーが保有する利用権（パス）の一覧・状態確認・QRコード表示・譲渡機能を提供する

import { useState } from 'react';
import Link from 'next/link';

// パスステータスの型定義
type PassStatus = 'ACTIVE' | 'IN_USE' | 'CONSUMED' | 'EXPIRED' | 'TRANSFERRED' | 'PENDING';
...
export default function PassesPage() {
  ...
  // フィルタリング処理
  const filtered = MOCK_PASSES.filter((p) => {
