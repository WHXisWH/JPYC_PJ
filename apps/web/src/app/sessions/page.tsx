  ...
  return (
    <div className="max-w-md mx-auto text-center">
      ...
      <div className="flex gap-3">
        <Link href="/passes" className="btn-secondary flex-1">マイパスへ</Link>
      ...
      <div className="container-main py-10">
        {checkoutResult ? (
          ...
          <div className="max-w-md mx-auto text-center py-20">
            ...
            <p className="text-slate-400 text-sm mb-8">マイパスのQRコードを使って、お近くの店舗でチェックインしましょう</p>
            <div className="flex gap-3 justify-center">
              <Link href="/passes" className="btn-secondary">マイパスを見る</Link>
